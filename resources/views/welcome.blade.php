                ...
                <div class="row pt-115">
                    <div class="col-lg-6">
                        <div class="travel-video relative">
                            ...
                            <img src="{{ asset('public/frontend') }}/images/about-us/vali.png" alt="Image"
                                class="mask-video tf-anime-rorate">
                                <img src="{{ asset('public/frontend') }}/images/page/enjoy.png" alt="Image"
                                class="mask-enjoy ">
                        </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="tab-tour-list">
                            <ul class="nav justify-content-center tab-list mb-37" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="los-angelas-tab" data-bs-toggle="tab" data-bs-target="#los-angelas-tab-pane" type="button" role="tab" aria-controls="los-angelas-tab-pane"  aria-selected="false">Los Angelas</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="tour-listing wow fadeInUp animated" data-wow-delay="0.1s">
                                                ...
                                                <div class="tour-listing-content">
                                                    ...
                                                    <h3 class="title-tour-list"><a href="tour-single.html">Days and 6 nights From Moscow</a></h3>
                                                    <div class="review">
                                                        <i class="icon-Star"></i>
                                                        <i class="icon-Star"></i>
                                                        <i class="icon-Star"></i>
